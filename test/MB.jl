...
function apply_MB_test(save_refs::Bool = false)
    ...
    # JET.@test_opt broken=true target_modules=(Sleipnir,Muninn) MB_timestep(model, glacier, step, t) # RasterStack manipulation is type unstable, so for the moment this test is deactivated
